...
class _ProductsViewState extends State<ProductsView> {
  ...
  Widget build(BuildContext context) {
    ...
    DataMap reservations = widget.reservations;
    if (widget.data.isNotEmpty) {
      product = widget.data[0];
    }
                      ...
                      child: GestureDetector(
                          onTap: () {
                            if (reservations[widget.salonId] != null) {
                              if (reservations[widget.salonId].isNotEmpty) {
                                if (reservations[widget.salonId][0]['date'] ==
                                    null) {
                                  openSnackBar(
                                      context,
                                ...
                                if (reservations[widget.salonId][0]['time'] ==
                                    null) {
                                  openSnackBar(
                                      context,
                            ...
                            child: Padding(
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    ...
                                    AutoSizeText('$totalPrice ${l10n.riyal}',
                                        style: TextStyles.inter.copyWith(
                                            color: Colors.white, fontSize: 15))
                                  ],
                                )),
